...
import { MatchIdToInteger1719000000000 } from './migrations/1719000000000-MatchIdToInteger.js'
...
export const AppDataSource = new DataSource({
  ...
  migrations: [AddWeightToMatches1718880000000, MatchIdToInteger1719000000000],
})